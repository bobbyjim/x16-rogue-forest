...
; Compiler:		CC65
; Build using:	cl65 -t cx16 rf-effects.s -C cx16-asm.cfg -o RF-EFFECTS.PRG
...
;
;  Each of these is an index into envelope information for each sound effect.
;
ping:
;*******************************************************************************
	ldx #0
...
sounds:			;     rlc  frequency  v  volume vol_chg  v_chg
			;     ---  --------- --- ------ -------  -----
ping_envelope:		.byte 100, 199,9,    160,0,63,  161,0,   0,  0 	; $050e - $0517
shoot_envelope:		.byte 20,  107,17,   224,0,63,  0,  3,   0,  0	; $0515 - $0521
zap_envelope:		.byte 37,  232,10,   96, 0,63,  179,1,   100,0  ; $0522 - $052B
explode_envelope:	.byte 200, 125,5,    224,0,63,  80, 0,   0,  0  ; $052C - $0535
